...
local widgetcolor = ""
if beautiful.fg_normal_secondary then
    widgetcolor = beautiful.fg_normal_secondary
else
    widgetcolor = beautiful.fg_normal
end
...
rebootmenu = { { "OK", "reboot" } }
poweroffmenu = { { "OK", "poweroff"} }
powermenu = {
    { "reboot", rebootmenu },
...
awful.util.spawn("xautolock -time 10 -corners '00+-' -locker slock")
